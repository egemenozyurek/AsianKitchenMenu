...
const buttonCreate = () => {
  let buttons = `<button type="button" id="All" class="btn btn-outline-dark mx-2">All</button>
...
//get all food list when page is loaded
...
let buttonEventForAll = document
  .getElementById("All")
  .addEventListener("click", listAllFood);
let buttonEventForKorea = document
  .getElementById("Korea")
  .addEventListener("click", listKoreansFood);
let buttonEventForJapan = document
  .getElementById("Japan")
  .addEventListener("click", listJapaneseFood);
let buttonEventForChina = document
  .getElementById("China")
  .addEventListener("click", listChineseFood);
